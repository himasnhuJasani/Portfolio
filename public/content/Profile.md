...
## About
With 4+ years in web development, I excel in crafting top-tier single-page applications using React, Vue, Next.js, HTML, CSS, and JavaScript. Experienced working with Zingtree, EY, PayPal and Blackboard, my skills span dynamic front-end solutions, trend-aware innovations, and collaborative project contributions. Dedicated to clean, maintainable code, I am poised for impactful contributions in future web development endeavors. Let's connect!
